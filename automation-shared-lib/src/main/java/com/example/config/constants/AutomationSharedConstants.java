...
public class AutomationSharedConstants {
	...
	public static final String AuthCodeClientSecret="secret";
	public static final String HOSTNAME="localhost";//instead of localhost can use machine name or ip if needed.
